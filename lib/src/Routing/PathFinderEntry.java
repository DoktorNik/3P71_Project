...
public class PathFinderEntry implements Comparable<PathFinderEntry>{
	 ...
	 * @param path              the path thus far
	 * @param pathCost          the cost of the path thus far
	 * @param heuristicScore    the heuristic score for this node
	 */
	...
	/**
	 * comparator for prioritizing nodes in the search
	 * uses distance + heuristic score
	 * fallback to distance in case of tiebreakers
	 *
